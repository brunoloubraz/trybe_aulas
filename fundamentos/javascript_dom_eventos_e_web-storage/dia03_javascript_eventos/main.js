...
// Isso ocorre devido a caixa de texto abaixo que possui uma margem que provavelmente está afetando a caixa
...
myWebpage.addEventListener('dblclick', () => {
  window.open('https://www.linkedin.com/in/bruno-loureiro-braz-000174154/');
});
