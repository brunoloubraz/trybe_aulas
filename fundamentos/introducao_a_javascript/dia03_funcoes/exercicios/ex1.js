...
function infoTriangle(l1, l2, l3) {
  let inteiroPositivo = checkIntegerPositive(l1, l2, l3);
  let isCheckWitchTriangle = checkWitchTriangle(l1, l2, l3);
  let isCheckPerimeterTriangle = checkPerimeterTriangle(l1, l2, l3);
  let formaTriangulo = checkItsATriangle(l1, l2, l3);

  if (inteiroPositivo && formaTriangulo) {
    return "O triângulo é do tipo " + isCheckWitchTriangle + " e seu periímetro vale " + isCheckPerimeterTriangle + "cm"
  }
  else {
    return " A função não é um triângulo"
